    ...
    return (
        <View style={{ flex: 1, justifyContent: 'center', backgroundColor: colors.bg }}>
            ...
            <Image
                ...
                blurRadius={100}
                source={{ uri: 'https://static-cse.canva.com/image/7209/Rose-Quartz_16.b7443828.png' }}
            />
            <View
                style={{
                    padding: SPACING,
...
function RoomComponent({ type, activeColor, iconOn, iconOff }) {
    ...
    return (
        ...
        >
            <View style={{ width: ICON_SIZE, height: ICON_SIZE, marginBottom: 10 }}>
                <AnimatePresence>
                    {!isEnabled ? (
                        ...
                        >
                            <MaterialCommunityIcons name={iconOff} size={ICON_SIZE} color='black' />
                        </MView>
                    ) : (
                        <MView
                            key={'on'}
                            ...
                            style={{ position: 'absolute' }}
                        >
                            <MaterialCommunityIcons name={iconOn} size={ICON_SIZE} color='white' />
                        </MView>
                    )}
                </AnimatePresence>
            </View>
            ...
            <Switch
                style={{ transform: [{ scale: 0.8 }], position: 'absolute', bottom: 20, left: 20 }}
